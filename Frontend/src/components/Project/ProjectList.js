                    ...
                    <Thead>
                        <Tr>
                            <Th bg="brand.pink" borderTopLeftRadius={25}>
                                <Text color="brand.background" fontSize="lg">Number </Text>
                            </Th>
                            <Th bg="brand.pink">
                                <Text color="brand.background" fontSize="lg">Name </Text>
                            </Th>
                            <Th bg="brand.pink">
                                <Text color="brand.background" fontSize="lg">Client</Text>
                            </Th>
                            <Th bg="brand.pink">
                                <Text color="brand.background" fontSize="lg">Date Required</Text>
                            </Th>
                            <Th bg="brand.pink">
                                <Text color="brand.background" fontSize="lg">Status</Text>
                            </Th>
                            <Th bg="brand.pink"/>
                        </Tr>
                    </Thead>
