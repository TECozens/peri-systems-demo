...
import CRUDTable, {Field, Fields, Pagination} from "react-crud-table";
...
const SORTERS = {
  ID_ASCENDING: mapper => (a, b) => mapper(a) - mapper(b),
  ID_DESCENDING: mapper => (a, b) => mapper(b) - mapper(a)
}
...
const getSorter = data => {
  ...
  sorter =
    data.direction === "ascending"
      ? SORTERS.ID_ASCENDING(mapper)
      : SORTERS.ID_DESCENDING(mapper);
